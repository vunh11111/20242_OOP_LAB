...
public class DigitalVideoDisc extends Media implements Playable {
    ...
    public DigitalVideoDisc(int i, String title, String category, float f, String director, float cost) {
        this.setId(++nbDigitalVideoDiscs);
        this.setTitle(title);
        this.setCategory(category);
    ...
    public DigitalVideoDisc(String dvdTitle, String dvdCategory, float dvdCost, String director2, int length2) {
